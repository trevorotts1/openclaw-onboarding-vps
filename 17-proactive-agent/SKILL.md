...
## Purpose
Recreated local version of ClawHub skill **proactive-agent** with all upstream markdown and support files preserved.

## MANDATORY FIRST STEP
Execute Teach Yourself Protocol on this folder before any install/use:
1. Read `SKILL.md`
2. Read `proactive-agent-full.md`
...
## Install target
Install to `~/.openclaw/skills/proactive-agent/` for local usage.

## Source
- ClawHub slug: `proactive-agent`
