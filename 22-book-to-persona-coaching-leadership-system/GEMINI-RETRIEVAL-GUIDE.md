...
```bash
python3 /data/.openclaw/onboarding/projects/gemini-migration/gemini-indexer.py --add \
...
```bash
python3 /data/.openclaw/onboarding/projects/gemini-migration/gemini-indexer.py
```

### Verify

```bash
python3 /data/.openclaw/onboarding/projects/gemini-migration/gemini-indexer.py --status
```
...
```bash
python3 /data/.openclaw/onboarding/projects/gemini-migration/gemini-search.py "methodology for building habits and systems for consistency"
python3 /data/.openclaw/onboarding/projects/gemini-migration/gemini-search.py "negotiation framework for difficult conversations and objection handling"
python3 /data/.openclaw/onboarding/projects/gemini-migration/gemini-search.py "sales questioning technique for uncovering customer problems"
```
...
```bash
python3 /data/.openclaw/onboarding/projects/gemini-migration/gemini-search.py "Atomic Habits coaching questions assessment phase"
python3 /data/.openclaw/onboarding/projects/gemini-migration/gemini-search.py "SPIN Selling decision logic framework agent governance"
python3 /data/.openclaw/onboarding/projects/gemini-migration/gemini-search.py "Never Split the Difference objection handling resistance"
```
...
```bash
python3 /data/.openclaw/onboarding/projects/gemini-migration/gemini-search.py "email outreach quality standard non-negotiable rules"
python3 /data/.openclaw/onboarding/projects/gemini-migration/gemini-search.py "sales call preparation checklist execution standard"
python3 /data/.openclaw/onboarding/projects/gemini-migration/gemini-search.py "leadership coaching session structure definition of done"
```
...
```bash
python3 /data/.openclaw/onboarding/projects/gemini-migration/gemini-search.py "failure patterns amateur mistakes sales execution"
python3 /data/.openclaw/onboarding/projects/gemini-migration/gemini-search.py "what bad coaching looks like versus expert coaching"
python3 /data/.openclaw/onboarding/projects/gemini-migration/gemini-search.py "content writing failure patterns quality markers"
```
...
```bash
python3 /data/.openclaw/onboarding/projects/gemini-migration/gemini-search.py "your question here"
```

**Example:**
```bash
python3 /data/.openclaw/onboarding/projects/gemini-migration/gemini-search.py "habit stacking implementation guide"
```

### Structured query (when you need precise control)
```bash
python3 /data/.openclaw/onboarding/projects/gemini-migration/gemini-search.py "habits systems consistency"
```
...
```bash
python3 /data/.openclaw/onboarding/projects/gemini-migration/gemini-search.py "all personas"
```
...
-> python3 /data/.openclaw/onboarding/projects/gemini-migration/gemini-search.py "sales outreach email quality standard execution rules"
...
```bash
python3 /data/.openclaw/onboarding/projects/gemini-migration/gemini-indexer.py --rebuild
python3 /data/.openclaw/onboarding/projects/gemini-migration/gemini-indexer.py
```
