...
mv /data/downloads/your-project-*.json /data/.openclaw/secrets/gcp-service-account.json
chmod 600 /data/.openclaw/secrets/gcp-service-account.json
...
Add these to your secrets file (`/data/.openclaw/secrets/.env`):
...
Then tell your AI:
> "My GCP service account is at `/data/.openclaw/secrets/gcp-service-account.json` and it impersonates `your-email@yourdomain.com`"
