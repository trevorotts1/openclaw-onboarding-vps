...
LEAD="$STAGE_DIR/.reference-sheet.lead.md"
{
  ...
  printf 'You do **not** have to build these yourself. **Just tell your AI, in plain English:** 💬\n\n'
  printf '```\n'
  printf 'Help me build a missed-call follow-up playbook\n'
  printf '```\n\n'
  printf 'That is the whole ask — say it like that and your AI takes it from there. Other examples you can copy word-for-word:\n\n'
  ...
  printf -- '- *"Help me build a [purpose] playbook"* — swap in whatever conversation you want handled.\n\n'
  printf '### ✅ What your AI will do when you ask\n\n'
  printf 'When you ask for a new communication playbook, your AI will:\n\n'
  printf -- '1. 💬 **Brainstorm it WITH you** using what it already knows about your business — a few smart questions, **not** a 50-question interrogation.\n'
  printf -- '2. 🛠️ **Create the communication playbook for you** (the script it follows for that conversation).\n'
  printf -- '3. 🗂️ **Store it for you** — the working copy is saved in your master-files `conversation-workflows/` folder and **mirrored to your Notion** so you have a readable copy you can share.\n'
  printf -- '4. 📝 **Build the matching Workflow AI prompt** that is wired to **YOUR Convert and Flow (GoHighLevel) account**, and tell you exactly what to paste where.\n'
  printf -- '5. 🤖 **Take real actions in Convert and Flow on your behalf** — your AI is connected to your account and can do these things for you, including:\n'
  printf -- '   - 🏷️ **create tags**,\n'
