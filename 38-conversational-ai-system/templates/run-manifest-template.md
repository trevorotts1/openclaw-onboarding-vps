<!-- OPERATOR HEADER -->
<!-- Skill 38 template: Run Manifest scaffold (VERBATIM from playbook v5.14 lines 854-892). -->
<!-- Created at the start of every run by scripts/22-init-run-manifest.sh. -->
<!-- Append every captured value, every step result, every deviation per Rule 3. -->
<!-- Future agents reconstruct the run from this file — keep it complete. -->
