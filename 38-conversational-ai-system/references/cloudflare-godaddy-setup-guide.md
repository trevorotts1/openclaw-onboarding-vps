...
- Part 4 (API token creation) produces the credential the agent reads from `~/.openclaw/.env` as `CLOUDFLARE_API_TOKEN`. The 9 permission rows map 1-to-1 to what the v6.0 playbook actually calls into:
