...
**🐜 Ant Farm exemption:** internal workflow micro-agents — any workspace matching `*/workflows/*/agents/*` (e.g. `workflows/bug-fix/agents/triager`) — are EXEMPT. Their core files are NEVER touched.
