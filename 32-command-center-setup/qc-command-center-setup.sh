...
if ! command -v resolve_platform_paths >/dev/null 2>&1; then
  resolve_platform_paths() { export SECRETS_ENV="/data/.openclaw/secrets/.env" WORKSPACE="/data/.openclaw/workspace" SKILLS_DIR_DEFAULT="/data/.openclaw/skills" CC_PORT=4000; }
fi
