...
Reads departments dynamically from (in priority order):
  1. /data/.openclaw/workspace/zero-human-company/<slug>/departments.json    (v9.6.0 canonical ZHC)
  2. /data/.openclaw/workspace/zhc/<slug>/departments.json                   (short-alias)
  3. /data/.openclaw/master-files/company-discovery/  (pre-v9.6.0 legacy)
  4. /data/.openclaw/workspace/departments/departments.json                  (very old legacy)
  5. Falls back to scanning workspace folders for dept directories

ALSO reads company name + brand colors + industry from:
  - /data/.openclaw/workspace/zero-human-company/<slug>/company-config.json  (v9.6.1+)
...
def _zhc_root_candidates():
    ...
    return [
        ...
        Path("/data/.openclaw/workspace/zero-human-company"),          # VPS canonical
        Path("/data/.openclaw/workspace/zhc"),                          # VPS short-alias
    ]
...
def find_departments_config():
    ...
    v9.6.1 priority order:
      1. ZHC canonical: /data/.openclaw/workspace/zero-human-company/<slug>/departments.json
      2. ZHC short-alias: /data/.openclaw/workspace/zhc/<slug>/departments.json
      3. Legacy company-discovery: /data/.openclaw/master-files/company-discovery/departments.json
      4. Older legacy: /data/.openclaw/workspace/departments/departments.json
...
def scan_skill23_workspaces():
    ...
    # Also scan /data/.openclaw/master-files/ for any department folders
