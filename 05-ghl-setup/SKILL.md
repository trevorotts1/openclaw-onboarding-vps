...
name: ghl-setup
description: >
  Foundational GoHighLevel (Convert and Flow) API connection setup — direct REST credential wiring, Private Integration Token, and base API patterns. Install before skill 36 MCP layers.
---
...
4. **Your agent should check two places for credentials:**
   - /data/.openclaw/secrets/.env (look for GHL_PIT or GOHIGHLEVEL_API_KEY)
   - /data/.openclaw/openclaw.json under env.vars
