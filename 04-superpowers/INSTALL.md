...
The agent must find the folder where OpenClaw master files are stored. This folder lives inside /data/.openclaw/master-files/. Possible names:
- openclaw-master-files
- OpenClaw Master Files
- OpenClaw Master Documents
- OpenClaw Documents
...
```
mkdir -p /data/.openclaw/master-files/superpowers
```
...
2. Wait for zip file to download to /data/.openclaw/master-files/
