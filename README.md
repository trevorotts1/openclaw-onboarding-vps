...
> **Version:** see `/version` - this repo at v10.16.52.
...
## 🔴 READ THIS FIRST — Deployment Models & Install Path (v10.16.52)
...
**Current Version:** see `/version` (currently **v10.16.52**) — see [CHANGELOG.md](CHANGELOG.md) for the full release history.
