...
> **Version:** see `/version` - this repo at v11.3.0.
...
## 🔴 READ THIS FIRST — Deployment Models & Install Path (v11.3.0)
...
**Current Version:** see `/version` (currently **v11.3.0**) — see [CHANGELOG.md](CHANGELOG.md) for the full release history.
