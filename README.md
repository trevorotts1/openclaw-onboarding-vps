...
> **Version:** see `/version` - this repo at v11.5.0.
...
## 🔴 READ THIS FIRST — Deployment Models & Install Path (v11.5.0)
...
**Current Version:** see `/version` (currently **v11.5.0**) — see [CHANGELOG.md](CHANGELOG.md) for the full release history.
