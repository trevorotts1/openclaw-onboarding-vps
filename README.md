...
> **Version:** see `/version` - this repo at v11.3.2.
...
## 🔴 READ THIS FIRST — Deployment Models & Install Path (v11.3.2)
...
**Current Version:** see `/version` (currently **v11.3.2**) — see [CHANGELOG.md](CHANGELOG.md) for the full release history.
