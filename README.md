...
> **Version:** see `/version` - this repo at v11.0.1.
...
## 🔴 READ THIS FIRST — Deployment Models & Install Path (v11.0.1)
...
**Current Version:** see `/version` (currently **v11.0.1**) — see [CHANGELOG.md](CHANGELOG.md) for the full release history.
