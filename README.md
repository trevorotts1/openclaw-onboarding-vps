...
> **Version:** see `/version` - this repo at v11.7.0.
...
## 🔴 READ THIS FIRST — Deployment Models & Install Path (v11.7.0)
...
**Current Version:** see `/version` (currently **v11.7.0**) — see [CHANGELOG.md](CHANGELOG.md) for the full release history.
