...
## 🔴 READ THIS FIRST — Deployment Models & Install Path (v11.8.0)
...
**Current Version:** see `/version` (currently **v11.8.0**) — see [CHANGELOG.md](CHANGELOG.md) for the full release history.
