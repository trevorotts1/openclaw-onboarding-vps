...
> **Version:** see `/version` - this repo at v10.16.46.
...
## 🔴 READ THIS FIRST — Deployment Models & Install Path (v10.16.46)
...
**Current Version:** see `/version` (currently **v10.16.46**) — see [CHANGELOG.md](CHANGELOG.md) for the full release history.
