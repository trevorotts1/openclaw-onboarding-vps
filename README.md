...
> **Version:** see `/version` - this repo at v11.1.0.
...
## 🔴 READ THIS FIRST — Deployment Models & Install Path (v11.1.0)
...
**Current Version:** see `/version` (currently **v11.1.0**) — see [CHANGELOG.md](CHANGELOG.md) for the full release history.
