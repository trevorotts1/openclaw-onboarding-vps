...
> **Version:** see `/version` - this repo at v10.16.15.
...
>
> **NOTE (v10.16.15) — Skill 38 Round-2 backlog shipped + version-surface roll:** This release ships the Skill 38 Round-2 backlog (six new default-OFF features) AND rolls the eight repo-version-tracked files forward to `v10.16.15` in the SAME merge, so the features and their advertising land together with no drift window. CI (`version-consistency.yml`) proves all eight agree.
>
...
## 🔴 READ THIS FIRST — Deployment Models & Install Path (v10.16.15)
