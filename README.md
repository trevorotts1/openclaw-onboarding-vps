...
> **Version:** see `/version` — this repo at v10.14.14.
...
>
> **NOTE (v10.14.14):** Bump-script coverage extended to track README.md and update-skills.sh — both used to drift independently of the 5 originally-tracked files. If you find a NEW version-bearing file in the future, ADD it to `scripts/bump-version.sh` before fixing the drift.
>
...
## 🔴 READ THIS FIRST — Deployment Models & Install Path (v10.14.14)
...
docker commit <openclaw-container> <client>-pre-v10.14.14
cd /docker/<project>-<suffix> && tar -czf /root/<client>-data-pre-v10.14.14.tar.gz data/
```
