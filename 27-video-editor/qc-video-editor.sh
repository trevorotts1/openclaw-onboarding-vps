#!/usr/bin/env bash
# Skill 27 — Video Editor — Install QC
set -u
...
echo ""
echo "═══ Skill 27 — Video Editor — Install QC ═══"
echo ""
assert "Skill 27 folder present" "[ -d \"$SKILLS_DIR_DEFAULT/27-video-editor\" ]"
...
warn_only "FFmpeg supports concat demuxer" "ffmpeg -formats 2>&1 | grep -qi 'concat'"
echo ""
echo "═══ Result: $PASS passed | $FAIL failed | $WARN warnings ═══"
[ $FAIL -gt 0 ] && { red "Skill 27 QC FAILED"; exit 1; } || { green "Skill 27 QC PASS"; exit 0; }
