# SuperDesign Instructions Setup - Core File Updates

Update ONLY the files listed below. Add the described section in the appropriate location.
...
Add a `## SuperDesign Web Design [PRIORITY: HIGH]` section.
...
Add a `## Design Capability` section.
- Summary: Agent uses SuperDesign for all UI/web design work - designs first, gets approval, then builds.
