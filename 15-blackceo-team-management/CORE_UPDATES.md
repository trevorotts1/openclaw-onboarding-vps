...
/data/.openclaw/master-files/[master-files-folder]/OpenClaw Onboarding/15-blackceo-team-management/blackceo-team-management-full.md
Team config lives in: /data/.openclaw/skills/15-blackceo-team-management/TEAM_CONFIG.md
...
- Team config (source of truth): /data/.openclaw/skills/15-blackceo-team-management/TEAM_CONFIG.md
...
- WORKFLOW_AUTO.md: /data/.openclaw/workspace/WORKFLOW_AUTO.md (routing table)
